...
<!--[if (gte IE 9)|(gt IEMobile 7)|!(IEMobile)|!(IE)]><!--><html class="no-js" lang="en"><!--<![endif]-->
  ...
  <body <?php body_class(); ?>>
     <header class="header" role="banner">
              <div class="pre-header cf dark-teal">
              ...
              <div class="header-nav subnavigation">
              
               <?php wp_nav_menu( array( 'theme_location' => 'subnavigation', 'container_class' => 'header-nav center-nav', 'menu_class' => 'sf-menu subnav') ); ?>
